...
public class SyllabusActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Log.d("time123", "onCreate: "+rvToDoList);
        initCurrentDate();
        initCalendarView();
    ...
    private void initListener() {
        onSelectDateListener = new OnSelectDateListener() {
            ...
            public void onSelectDate(CalendarDate date) {
                ...
                String month = (date.getMonth()>9) ? (date.getMonth()+"") : ('0'+(date.getMonth()+""));
                String day = (date.getDay()>9) ? (date.getDay()+"") : ('0'+(date.getDay()+""));
                String clickDay = year+month+day;
                Toast.makeText(SyllabusActivity.this,clickDay+"",Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(SyllabusActivity.this, NotepadActivity.class);
                intent.putExtra("clickDay",clickDay);
